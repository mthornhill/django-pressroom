...
DATABASES = {
    'default': {
        ...
        'NAME': 'pressroom.db',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.realpath(os.path.join(DIRNAME, 'media/'))
...
STATIC_ROOT = os.path.realpath(os.path.join(DIRNAME, 'static/'))
...
SECRET_KEY = 'ru4za5#v#n9(#j!)kvih#0h%gf!vba&$exsf^zeyn2gs4fq4#s'
