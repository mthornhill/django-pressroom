...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.translation_of'
        db.add_column('pressroom_article', 'translation_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pressroom.Article'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.translation_of'
        db.delete_column('pressroom_article', 'translation_of_id')
    ...
    models = {
        ...
        'pressroom.article': {
            ...
            'translation_of': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pressroom.Article']", 'null': 'True', 'blank': 'True'}),
